...
@Configuration
@EnableJpaRepositories(basePackages = "manshop.repository")
...
public class SpringConfig {
    ...
    DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/man_shop"); //spring-jpa-1: database name
        dataSource.setUsername("root");
        dataSource.setPassword("anhquoc");
        return  dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        entityManager.setPackagesToScan("manshop.entity");
