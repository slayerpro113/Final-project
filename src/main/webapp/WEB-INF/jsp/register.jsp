                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form:form id="register-form" action="register" method="post"
                                       role="form" style="display: block" modelAttribute="userEntity">
                                <span style="color: red;font-size: medium">${message}</span>
                                <div class="form-group">
                                    <lable><strong>Email Address: </strong><span style="color: red;">*</span></lable>
                                    <form:input type="email" path="email"
                                                tabindex="1" class="form-control form_input"  required="required"/>
                                </div>
                                <div class="form-group">
                                    <lable><strong>Password: </strong><span style="color: red;">*</span></lable>
                                    <input type="password" name="pass"
                                           tabindex="2" class="form-control form_input" minlength="8" maxlength="20" required="required"/>
                                </div>
                                <div class="form-group">
                                    <lable><strong>Full Name:</strong> <span style="color: red;">*</span></lable>
                                    <form:input type="text" path="fullName" id="fullName"
                                                tabindex="3" class="form-control form_input" maxlength="20" required="required"  />
                                </div>
                                <div class="form-group">
                                    <lable><strong>Address: </strong> <span style="color: red;">*</span></lable>
                                    <form:textarea type="text" path="address" id="address"
                                                tabindex="4" class="form-control form_input" required="required" />
                                </div>
                                <div class="form-group">
                                    <lable><strong>Phone: </strong><span style="color: red;">*</span></lable>
                                    <form:input type="text" path="phone" id="phone"
                                                tabindex="5" class="form-control form_input" maxlength="10" required="required"/>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <input type="submit" name="register-submit"
                                                   id="register-submit" tabindex="6" class="form-control btn btn-register" value="Register Now">
                                        </div>
                                    </div>
                                </div>
                            </form:form>
