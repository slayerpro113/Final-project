...
<section class="bgwhite p-t-66 p-b-38">
	<div class="container">
		<div class="row">
			<div class="col-md-4 p-b-30">
				<div class="hov-img-zoom">
					<img src="/resources/images/avatar/2.jpg" alt="IMG-ABOUT">
				</div>
			</div>
			...
			<div class="col-md-8 p-b-30">
				...
				<p class="p-b-28">
					<p>Full Name: Huỳnh Đăng Hưng</p><br>
					<p>Date of Birth: 23/4/1996</p><br>
					<p>Job: 4th year student at Da Nang University of science and technology</p><br>
					<p>Major: Information technology</p><br>
				<p >Facebook: <a href="https://www.facebook.com/huynhdanghung">https://www.facebook.com/huynhdanghung</a></p>
				</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4 p-b-30">
				<div class="hov-img-zoom">
					<img src="/resources/images/avatar/1.jpg" alt="IMG-ABOUT">
				</div>
			</div>

			<div class="col-md-8 p-b-30">
				<p class="p-b-28">
					<p>Full Name: Hồ Văn Anh Quốc</p><br>
					<p>Date of Birth: 13/11/1995</p><br>
					<p>Job: 4th year student at Da Nang University of science and technology</p><br>
					<p>Major: Information technology</p><br>
					<p >Facebook: <a href="https://www.facebook.com/tribute.to.chester"> https://www.facebook.com/tribute.to.chester</a></p>
				</p>
			</div>
		</div>
	</div>
