    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-login">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-12">
                        <a class="active" id="register-form-link" style="color: #0c5460">Search for your account</a>
                    </div>
                </div>
                <hr>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="password-form"  action="reset_password" method="post"  style="display: block;" >
                            <p style="color: #138496;font-size: medium;margin-left: 7em">${message}</p>
                            <p style="color: #bd2130;font-size: medium;margin-left: 6em">${errorMessage}</p><br>
                            <div class="form-group">
                                <lable>Please enter your email to recover your password:</lable>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3">
                                        <input type="submit" name="submit"
                                               tabindex="2" class="form-control btn btn-register" value="Submit">
                                    </div>
                                </div>
                            </div>
                        </form>
